...
public record PrimeGarantieCreateRequest(
        ...
        @NotNull(message = "Produit UUID is required")
        UUID produitUuid,

        @NotNull(message = "Garantie UUID is required")
        UUID garantieUuid,
        ...
        @NotNull(message = "Compagnie UUID is required")
        UUID compagnieUuid,
